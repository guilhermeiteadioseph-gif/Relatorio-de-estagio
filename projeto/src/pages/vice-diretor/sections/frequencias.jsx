...
/** Aba de Fichas de Frequência — visão geral de todos os estagiários. */
export default function FrequenciasSection() {
  const { estagiarios } = useViceDiretor()
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-slate-50 hover:bg-slate-50">
              ...
              <TableHead className="font-semibold text-slate-600 w-56">Progresso</TableHead>
