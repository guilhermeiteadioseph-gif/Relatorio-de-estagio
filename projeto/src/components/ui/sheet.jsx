  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          // FUNDO BRANCO + texto escuro (mesma lógica do Dialog)
          "fixed z-50 flex flex-col gap-4 bg-white text-slate-900 bg-clip-padding shadow-lg transition duration-200 ease-in-out",
